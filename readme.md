...
|-----|-----------------------------|-------------------------------------------------------|------|
| 01  | Age Checker                 | Life timer showing years, months, days, and more.     | [View](./project_1%20(Checking%20Age)/) |
| 02  | GitHub Profile Checker      | Checks GitHub user profile via GitHub API.            | [View](./project_2%20(Checking%20Github%20Account)/) |
| 03  | Random Question Generator   | Generates random math questions and tracks score.     | [View](./project_3%20(random%20QA)/) |
| 04  | Digital Clock               | Real-time clock with hour, minute, second, and AM/PM  | [View](./project_4%20(Degital%20Clock)/) |
| 05  | Random Color Palette Generator | Creates random color blocks with HEX codes         | [View](./project_5%20(Color%20Palete%20)/) |
| 06  | Loan Calculator             | Calculates monthly loan payments interactively        | [View](./project_6%20(Loan%20Calculator)/) |
| 07  | QR Code Generator           | Create QR codes from user input using an external API | [View](./project_7%20(QR%20Code)/) |
| 08  | Analog Clock                | A simple analog clock.                                | [View](<./project_8%20(Analog_clock)/>) |
| 09  | Theme Changer               | A simple theme changer.                               | [View](<./project_9%20(Theme%20changer)/>) |
| 10  | Tic Tac Toe                 | A simple tic tac toe game.                            | [View](<./project_10%20(Tik%20Tak%20Toe)/>) |
| 11  | Heart Emoji                 | A simple heart emoji animation.                       | [View](<./project_11%20(heart%20emoji)/>) |
| 12  | Palindrome Checker          | A simple palindrome checker.                          | [View](<./project_12%20(palindrome)/>) |
